...
int Book::allotbookid()
{
    ...
    Book temp;
    int id = 0;
    fin.open("../Dummy.txt", ios::in | ios::binary);
    if (!fin)
        return (id + 1);
    else
    {
...
{
    ofstream fout;
    fout.open("../Dummy.txt", ios::out | ios::app | ios::binary);
    if (!fout)
...
void Book::modifybook()
{
    int id, r = 0;
    fstream file;
    file.open("../Dummy.txt", ios::in | ios::out | ios::ate | ios::binary);
...
void Book::deletebook()
{
    ...
    else
    {
        ...
        system("erase ../Dummy.txt");
        system("rename ../tempbooks.txt ../Dummy.txt");
    }
}
int menu()
{
